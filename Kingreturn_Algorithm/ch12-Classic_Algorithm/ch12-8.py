...
def htree(order, center, ht):
    ...
    if order >= 0:
        ...
        drawLine([center[0] - ht / 2, center[1]], [center[0] + ht / 2, center[1]])  # 繪製H水平線
