def getPlaylist(request): #根據局號抓取　暱稱　下注結果　玩家下注結算餘額
   if request.method == 'POST':
      ...
      if grouplist.objects.filter(Data_B=Datab,Num_B=numB).exists():
         ...
         return response
      numBoard = grouplist.objects.filter(Data_B=Datab,Num_B=numB).get().Num_Board
      playbetResult = playbetlist.objects.filter(Num_Board=numBoard)
      resultList = []
      for item in playbetResult:
         user_name = reg.objects.filter(line_Id=item.line_Id).get().user_name
         itemdict = {
...
def setAmount(request): # 修改金額
   if request.method == 'POST':
      ...
      uacc.save()
      # 玩家還原金額紀錄錢包
      user=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.LId),Cause=cause,Amt_In='0',Amt_Out=str(aocu),Amt_All=uacc.sum_amt,Create_Time=gettime())
      user.save()
      ...
      bma.save()
      # 莊家還原金額紀錄錢包
      bm=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId),Cause=cause,Amt_In=str(aocb),Amt_Out='0',Amt_All=bma.sum_amt,Create_Time=gettime())
      bm.save()
      ...
      bma1.save()
      # 配莊1還原金額紀錄錢包
      bm1=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId1),Cause=cause,Amt_In=str(aocb1),Amt_Out='0',Amt_All=bma1.sum_amt,Create_Time=gettime())
      bm1.save()
      ...
      bma2.save()
      # 配莊2還原金額紀錄錢包
      bm2=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId2),Cause=cause,Amt_In=str(aocb2),Amt_Out='0',Amt_All=bma2.sum_amt,Create_Time=gettime())
      bm2.save()
      ...
      bma3.save()
      # 配莊3還原金額紀錄錢包
      bm3=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId3),Cause=cause,Amt_In=str(aocb3),Amt_Out='0',Amt_All=bma3.sum_amt,Create_Time=gettime())
      bm3.save()
      ...
      bma4.save()
      # 配莊4還原金額紀錄錢包
      bm4=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId4),Cause=cause,Amt_In=str(aocb4),Amt_Out='0',Amt_All=bma4.sum_amt,Create_Time=gettime())
      bm4.save()
      ...
      bma5.save()
      # 配莊5還原金額紀錄錢包
      bm5=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId5),Cause=cause,Amt_In=str(aocb5),Amt_Out='0',Amt_All=bma5.sum_amt,Create_Time=gettime())
      bm5.save()
      ...
      # 新增玩家變動後金額錢包紀錄
      if aoccu != 0:
         user=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.LId),Cause=cause,Amt_In='0',Amt_Out=str(aoccu),Amt_All=uacc.sum_amt,Create_Time=gettime())
         user.save()
      # 莊家變動後金額
      ...
      cause='8'
      if aoccb != 0:
         bm=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId),Cause=cause,Amt_In=str(aoccb),Amt_Out='0',Amt_All=bma.sum_amt,Create_Time=gettime())
         bm.save()
      ...
      cause='8'
      if aoccb1 != 0:
         bm1=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId1),Cause=cause,Amt_In=str(aoccb1),Amt_Out='0',Amt_All=bma1.sum_amt,Create_Time=gettime())
         bm1.save()
      ...
      cause='8'
      if aoccb2 != 0:
         bm2=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId2),Cause=cause,Amt_In=str(aoccb2),Amt_Out='0',Amt_All=bma2.sum_amt,Create_Time=gettime())
         bm2.save()
      ...
      cause='8'
      if aoccb3 != 0:
         bm3=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId3),Cause=cause,Amt_In=str(aoccb3),Amt_Out='0',Amt_All=bma3.sum_amt,Create_Time=gettime())
         bm3.save()
      ...
      cause='8'
      if aoccb4 != 0:
         bm4=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId4),Cause=cause,Amt_In=str(aoccb4),Amt_Out='0',Amt_All=bma4.sum_amt,Create_Time=gettime())
         bm4.save()
      ...
      cause='8'
      if aoccb5 != 0:
         bm5=BetList(GroupId=gid,Tid='0',Corp_Id=str(Corp_Id),Cnumber=nb,User_Id=str(PBLData.BId5),Cause=cause,Amt_In=str(aoccb5),Amt_Out='0',Amt_All=bma5.sum_amt,Create_Time=gettime())
         bm5.save()
